...
const locale = "en-US";
const timezone = "UTC";
function formatFeeds(feeds, format, startFlag, endFlag) {
...
function formatFeed(feed, format, fields) {
    ...
    const args = {
        ...
        month: feedDate === null || feedDate === void 0 ? void 0 : feedDate.toLocaleString(locale, { month: 'numeric' }),
